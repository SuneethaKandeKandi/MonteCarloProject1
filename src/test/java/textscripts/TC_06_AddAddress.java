...
public class TC_06_AddAddress extends BaseClass {
	...
	public void addingAddress() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		logger.info("Opened Account page");
		...
		utilities.dropDown(newAddress.getAddressNewProvince(),dataUtility.readingDataPropertyFile("State"));
		newAddress.addresscheckBoxClick();
		newAddress.newAddressButtonClick();	
		logger.debug("Address Added to page");
		logger.info("Class Adding address ran successfully");
    }
}
